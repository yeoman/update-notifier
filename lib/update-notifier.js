...
function UpdateNotifier(options) {
	...
	this.updateCheckInterval = options.updateCheckInterval != null ? options.updateCheckInterval : 1000 * 60 * 60 * 24; // 1 day
	this.updateCheckTimeout = options.updateCheckTimeout != null ? options.updateCheckTimeout : 20000;                  // 20 secs
